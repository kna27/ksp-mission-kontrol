...
Your directory should look like: `YourKSPInstallDirectory/Kerbal Space Program/GameData/KSPMissionKontrol` if done correctly.

## How to use

Press `alt + n` to open the GUI for the mod.

Detailed instructions can be found [on the Wiki](https://github.com/kna27/ksp-mission-kontrol/wiki/How-To-Use)
